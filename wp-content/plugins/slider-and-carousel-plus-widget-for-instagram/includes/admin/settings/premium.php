...
<div class="wrap">
	...
	<div class="iscw-notice">
		<a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=49165&edd_options[price_id]=3&ref=wposthemeplugin" target="_blank">Upgrade</a> a plugin within a minute and unloack many features now!!!
	</div>

	<style>
		.iscw-notice{padding: 10px; color: #3c763d; background-color: #dff0d8; border:1px solid #d6e9c6; margin: 0 0 20px 0;}
	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=49165&edd_options[price_id]=3&ref=wposthemeplugin" target="_blank">Upgrade Now</a></td>
	    	</tr>
	    </tfoot>
