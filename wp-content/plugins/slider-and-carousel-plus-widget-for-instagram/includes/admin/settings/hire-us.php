...
<div class="wrap">
	...
	<h2><?php _e( 'Hire Us - Get Unlimited Expert WordPress Support and Development', 'slider-and-carousel-plus-widget-for-instagram' ); ?></h2><br />

	<div class="support-data">
		<h3 style="margin-bottom:5px;"><?php _e( 'Highlight of Hiring:', 'slider-and-carousel-plus-widget-for-instagram' ); ?></h3>
		<ul>
		 	<li><?php _e('Hire once, get unlimited jobs done', 'slider-and-carousel-plus-widget-for-instagram'); ?></li>				 	
		 	<li><?php _e('Quick ticket support, quick solution', 'slider-and-carousel-plus-widget-for-instagram'); ?></li>
		 	<li><?php _e('Any sort of WP work with no extra cost', 'slider-and-carousel-plus-widget-for-instagram'); ?></li>
		 	<li><?php _e('Dedicated expert working only for you!', 'slider-and-carousel-plus-widget-for-instagram'); ?></li>
		</ul>
	</div>	
	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <tfoot>
	    	<tr>
	    		<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=6&ref=wposthemeplugin" target="_blank"><?php _e('Hire Us', 'slider-and-carousel-plus-widget-for-instagram'); ?></a></td>
	    		<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=3&ref=wposthemeplugin" target="_blank"><?php _e('Hire Us', 'slider-and-carousel-plus-widget-for-instagram'); ?></a></td>
	    		<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=4&ref=wposthemeplugin" target="_blank"><?php _e('Hire Us', 'slider-and-carousel-plus-widget-for-instagram'); ?></a></td>
				<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=5&ref=wposthemeplugin" target="_blank"><?php _e('Hire Us', 'slider-and-carousel-plus-widget-for-instagram'); ?></a></td>
			</tr>
	    </tfoot>
	</table>
</div>